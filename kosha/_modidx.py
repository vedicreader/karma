...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'kosha.cli': { 'kosha.cli._print_results': ('cli.html#_print_results', 'kosha/cli.py'),
            ...
            'kosha.graph': { 'kosha.graph.CodeGraph': ('graph.html#codegraph', 'kosha/graph.py'),
                             ...
                             'kosha.graph._body_calls': ('graph.html#_body_calls', 'kosha/graph.py'),
                             ...
                             'kosha.graph._fast_defs': ('graph.html#_fast_defs', 'kosha/graph.py'),
                             'kosha.graph._fast_edges': ('graph.html#_fast_edges', 'kosha/graph.py'),
